...
val LedgerLightBackground = Color(0xFFF4F7FB)
val LedgerLightSidebar = Color(0xFFEAF0F7)
val LedgerLightSurface = Color(0xFFFFFFFF)
val LedgerLightRaised = Color(0xFFF7F9FC)
val LedgerLightBorder = Color(0xFFD5DFEC)
val LedgerLightText = Color(0xFF14233B)
val LedgerLightSubtext = Color(0xFF52647D)
val LedgerLightBlue = Color(0xFF146BD6)
val LedgerLightGreen = Color(0xFF167A4B)
val LedgerLightRed = Color(0xFFC43C51)
